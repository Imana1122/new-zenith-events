                ...
                <Box mt={10}>
                  <Grid container spacing={2}>
                    ...
                    {contact.instagram_link && (
                      <Grid item>
                        <Link to={contact.instagram_link}>
                          <FaInstagram
                            className="text-2xl text-white hover:text-blue-700 cursor-pointer"
                          />
                        </Link>
